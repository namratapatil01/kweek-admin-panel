...
return [
    ...
    'vendor-categories' => [
        ...
        'form' => [
            ...
            ['name' => 'show_in_homepage', 'type' => 'checkbox', 'label' => 'Show In Home'],
            ['name' => 'review_attributes', 'type' => 'json', 'label' => 'Review Attributes'],
        ],
    ],
    'vendor-filters' => [
    ...
    'users' => [
        ...
        'form' => [
            ...
            ['name' => 'phoneNumber', 'type' => 'text', 'label' => 'Phone'],
            ['name' => 'profilePictureURL', 'type' => 'text', 'label' => 'Profile Image URL'],
