...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Create a Currency</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('currencies') }}">Currencies List</a></li>
                <li class="breadcrumb-item active">Create a Currency</li>
            </ol>
        </div>
    </div>
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="number" name="decimal_degits" class="form-control" value="{{ old('decimal_degits', 0) }}" min="0" max="10">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12 form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <input type="checkbox" class="custom-control-input" name="symbolAtRight" id="symbolAtRight" value="1" {{ old('symbolAtRight') ? 'checked' : '' }}>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12 form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <input type="checkbox" class="custom-control-input" name="isActive" id="isActive" value="1" {{ old('isActive') ? 'checked' : '' }}>
