...
<div class="page-wrapper">
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{!! route('brands.index') !!}">{{trans('lang.brand')}}</a></li>
    ...
    <div class="form-group col-12 text-center">
        ...
        <a href="{!! route('brands.index') !!}" class="btn btn-default" style="background: #979797;color: #fff;"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
    </div>
</div>
@endsection
@section('scripts')
