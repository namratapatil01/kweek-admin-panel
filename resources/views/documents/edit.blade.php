    ...
    <div class="container-fluid">
        <div class="card border">
            <div class="card-body">
                ...
                <form action="{{ route('documents.update', $record->id) }}" method="POST" id="document-form">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="vendor_payout_create-inner">
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $record->title) }}" required>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <select class="form-control" id="type" name="type">
                                            <option value="vendor" {{ old('type', $record->type) == 'vendor' ? 'selected' : '' }}>{{ trans('lang.document_vendor') }}</option>
                                            <option value="driver" {{ old('type', $record->type) == 'driver' ? 'selected' : '' }}>{{ trans('lang.document_driver') }}</option>
                                            <option value="owner" {{ old('type', $record->type) == 'owner' ? 'selected' : '' }}>{{ trans('lang.document_owner') }}</option>
                                        </select>
                                ...
                                <div class="form-group row width-50">
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" id="frontSide" name="frontSide" value="1" {{ old('frontSide', $record->frontSide) ? 'checked' : '' }}>
                                ...
                                <div class="form-group row width-50">
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" id="backSide" name="backSide" value="1" {{ old('backSide', $record->backSide) ? 'checked' : '' }}>
                                ...
                                <div class="form-group row width-50">
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" id="enable" name="enable" value="1" {{ old('enable', $record->enable) ? 'checked' : '' }}>
