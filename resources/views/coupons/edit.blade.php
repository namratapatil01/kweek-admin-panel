...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="coupon-card">
            ...
            <div class="coupon-card-title">EDIT COUPON</div>
            ...
            <form action="{{ route('coupons.update', $coupon->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    ...
                    <select name="vendor_id" class="cf-input">
                        ...
                        @foreach($vendors as $v)
                            <option value="{{ $v->id }}"
                                {{ old('vendor_id', $coupon->vendorID ?? '') == $v->id ? 'selected' : '' }}>
                                {{ $v->title }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea name="description"
                              ...
                              rows="6">{{ old('description', $payload['description'] ?? '') }}</textarea>
                ...
                <div class="form-group mb-4">
                    ...
                    @if(!empty($payload['image']))
                        <div class="mb-2">
                            <img src="{{ $payload['image'] }}" alt="Current"
                                 style="max-height:80px; border-radius:5px; border:1px solid #ddd;"
                                 onerror="this.style.display='none'">
                            <div class="cf-hint mt-1">Current image</div>
                        </div>
                    @endif
