...
<script type="text/javascript">
        ...
        async function buildHTML(val) {
            ...
            var document_list_view = '/deliveryman/document-list/' + val.id;
            var action = '';
            action = action + '<span class="action-btn">';
            action = action + '<a href="' + document_list_view + '" data-toggle="tooltip" data-bs-original-title="{{ trans('lang.document') }}"><i class="fa fa-file"></i></a>';
            action = action + '<?php if(in_array('deliveryman.edit', json_decode(@session('user_permissions'),true))){ ?><a href="' + route1 + '" data-toggle="tooltip" data-bs-original-title="{{ trans('lang.edit') }}"><i class="mdi mdi-lead-pencil"></i></a><?php } ?>';
